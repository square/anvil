...
public sealed class TopLevelFunctionReference : AnnotatedReference, FunctionalReference {
  ...
  public class Psi internal constructor(
  ...
  ) : TopLevelFunctionReference(), FunctionalReference.Psi {
    ...
    override fun visibility(): Visibility {
      return when (val visibility = function.visibilityModifierTypeOrDefault()) {
        ...
        else -> throw AnvilCompilationExceptionFunctionalReference(
  ...
  public class Descriptor internal constructor(
    ...
    override val module: AnvilModuleDescriptor,
  ) : TopLevelFunctionReference(), FunctionalReference.Descriptor {
